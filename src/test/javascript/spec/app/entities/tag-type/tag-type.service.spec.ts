...
describe('Service Tests', () => {
  describe('TagType Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new TagType(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a TagType', async () => {
      ...
      it('should update a TagType', async () => {
        const returnedFromService = Object.assign(
          {
            code: 'BBBBBB',
            name: 'BBBBBB',
      ...
      it('should return a list of TagType', async () => {
        const returnedFromService = Object.assign(
          {
            code: 'BBBBBB',
            name: 'BBBBBB',
      ...
      it('should delete a TagType', async () => {
