...
describe('Service Tests', () => {
  describe('Skills Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Skills(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Skills', async () => {
      ...
      it('should update a Skills', async () => {
        const returnedFromService = Object.assign(
          {
            skillCode: 'BBBBBB',
            skillName: 'BBBBBB'
      ...
      it('should delete a Skills', async () => {
